-- 插入美元、歐元、日圓、英鎊、澳幣、加幣、瑞士法郎、人民幣、新台幣
...
-- INSERT INTO currency (code, name_zh) VALUES ('CNY', '人民幣');
-- INSERT INTO currency (code, name_zh) VALUES ('TWD', '新台幣');
-- INSERT INTO currency (code, name_zh) VALUES ('KRW', '韓元');
-- INSERT INTO currency (code, name_zh) VALUES ('HKD', '港幣');
-- INSERT INTO currency (code, name_zh) VALUES ('SGD', '新加坡元');
